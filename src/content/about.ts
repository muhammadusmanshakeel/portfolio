export const aboutContent = {
  ...
  paragraphs: [
    ...
    "I bring roughly four years of professional web development experience. Design didn’t stay behind as a separate chapter — it became an advantage: I can read visual intent, translate designs into clean responsive interfaces, and keep the connection between look, structure, and code intentional.",
  ],
  highlights: [
    {
      label: "Path",
